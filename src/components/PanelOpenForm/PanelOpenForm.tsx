...
export function PanelOpenForm() {
  ...
  return (
    <div className={style.panel}>
      ...
      <PanelGroup title="">
        {tree.map(node => <div className={style.root}><Item node={node} depth={0} /></div>)}
      </PanelGroup>
    </div>
  )
}
